...
function CreatePlaylistComponent({isOpen, onClose}) {
    ...
    const createPlaylist = async () => {
        try {
            const response = await fetch({
                ...
                body: JSON.stringify({
                    playlistImage: formData.image,
                    playlistName: formData.name,
            ...
            console.log("failed to make playlist", error)
        }
    }
        ...
        <div
            ...
            <div className="bg-[#0D2132] rounded-2xl">
                ...
                <form onSubmit={handleSubmit} method="POST">
                    ...
                    <div className="p-8">
                        {/* Title */}
                        <h2 className="text-2xl font-bold mb-8 text-[#DEF9F6] tracking-tight">Create playlist</h2>
